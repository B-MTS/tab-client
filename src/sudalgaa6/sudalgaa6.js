...
<div  style={{height:"750px",background: '#f2f2f2',width:"100%",border:'double', font:"16px/26px Georgia, Garamond, Serif",overflow:"auto"}}>
     ...
     <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
        ...
        <FormGroup>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="exampleText"><b>Хандив өгсөн иргэн, байгууллагын нэр:</b></Label>
      ...
      <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
        ...
        <FormGroup>
          ...
          <option value="">Та сонголт хийнэ үү.</option>
            <option>Мөнгө</option>
            <option>Бараа материал</option>
            <option>Үндсэн хөрөнгө</option>
            <option>Мал амьтад</option>
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Орлогын дүн:</Label>
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Дансны нэр:</Label>
          <Input required type="text" name="RENEW_EMP_SALARY" id="RENEW_EMP_SALARY" onChange={this.onChange} value={this.state.RENEW_EMP_SALARY === null ? '' : this.state.RENEW_EMP_SALARY}  placeholder="Та утга оруулна уу." />
        ...
        <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
          <h1 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Хандивыг зарцуулах тухай шийдвэрийн огноо, дугаар</b></h1>
          <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
        <FormGroup>
        ...
        <FormGroup style={{paddingLeft:'60px'}}>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="SURVEY_ID">Зориулалт бусаар зарцуулсан дүн:</Label>
        ...
        <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
          <h1 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Үлдэгдэл  дүн</b></h1>
          <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
        <FormGroup>
