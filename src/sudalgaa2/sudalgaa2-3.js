...
class Sudalgaa2_3 extends React.Component {
  state = {
    ID : 0,
    HEMNELT_DUN: '',
    HEMNELT_PERCENT: '',
...
<div  style={{height:"750px",background: '#f2f2f2',width:"100%",border:'double', font:"16px/26px Georgia, Garamond, Serif",overflow:"auto"}}>
      ...
      <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
        ...
        <FormGroup>
        <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="IMP_SALARY_COUNT">ТУЗ-ийн бүрэлдэхүүн</Label>
        ...
        <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
          <h1 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>ТУЗ-ийн бүрэлдэхүүн болсон шийдвэрийн огноо, дугаар</b></h1>
          <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
        <FormGroup>
        ...
        <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
          <h1 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Одоо ажиллаж байгаа байгууллагын нэр</b></h1>
          <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
    
        
        <FormGroup>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="exampleText"><b>Байгууллагын нэр:</b></Label>
        ...
        <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
          <h1 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Сарын цалин</b></h1>
          <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
        <FormGroup>
        <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="CAR_AMOUNT">Сарын цалин:</Label>
        ...
        <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
          <h1 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Урамшуулал</b></h1>
          <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
        <FormGroup>
        <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="CAR_AMOUNT">Урамшуулал:</Label>
          <Input required type="number" name="CAR_AMOUNT" id="CAR_AMOUNT" onChange={this.onChange} value={this.state.CAR_AMOUNT === null ? '' : this.state.CAR_AMOUNT}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." />
          <br></br>
          <small class="help-block">/Төгрөгөөр/</small>
        ...
        <FormGroup>
          ...
          <br></br>
          <small class="help-block">/Тоогоор/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="CAR_AMOUNT">Нэг удаагийн тэтгэмж, орон сууцны хөнгөлөлтийн дүн:</Label>
          <Input required type="number" name="CAR_AMOUNT" id="CAR_AMOUNT" onChange={this.onChange} value={this.state.CAR_AMOUNT === null ? '' : this.state.CAR_AMOUNT}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." />
          <br></br>
          <small class="help-block">/Төгрөгөөр/</small>
