...
class Sudalgaa7 extends React.Component {
  state = {
    ID : 0,
    HEMNELT_DUN: '',
    HEMNELT_PERCENT: '',
...
<div  style={{height:"750px",background: '#f2f2f2',width:"100%",border:'double', font:"16px/26px Georgia, Garamond, Serif",overflow:"auto"}}>
     ...
     <FormGroup style={{border:'0.3px dashed #ccc', padding:'10px',}}>    
        ...
        <FormGroup>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="exampleText"><b>Эрүүл мэндийн байгууллагын нэр:</b></Label>
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Коронавируст халдвараар өвчилсөн хүний тоо:</Label>
        ...
        <FormGroup style={{paddingLeft:'60px'}}>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="SURVEY_ID">Гэрээр эмчлүүлсэн өвчтөний тоо:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="тоон утга оруулна уу." required/>
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Нэхэмжилсэн санхүүжилтийн дүн:</Label>
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">ЭМДС-аас олгосон санхүүжилт:</Label>
          <Input required type="number" name="RENEW_EMP_SALARY" id="RENEW_EMP_SALARY" onChange={this.onChange} value={this.state.RENEW_EMP_SALARY === null ? '' : this.state.RENEW_EMP_SALARY}  placeholder="Мөнгөн дүнг төргөрөөр оруулна уу." />
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Коронавируст халдварын эмчилгээ үйлчилгээний нийт зардал:</Label>
          <Input required type="number" name="RENEW_EMP_SALARY" id="RENEW_EMP_SALARY" onChange={this.onChange} value={this.state.RENEW_EMP_SALARY === null ? '' : this.state.RENEW_EMP_SALARY}  placeholder="Мөнгөн дүнг төргөрөөр оруулна уу." />
     
          <small class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="phone"><b>Үүнээс:</b></Label><br></br>
        <FormGroup style={{paddingLeft:'60px'}}>
        <h3 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Бэлтгэсэн эмийн багцын зардал</b></h3>
        <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>
        <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Тоо:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="тоон утга оруулна уу." required/>
   
          <small  class="help-block">/Тоогоор/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Мөнгөн дүн:</Label>
          ...
          <small  class="help-block">/Төгрөгөөр/</small>
          <h3 style={{color:'#002d74',marginBottom:'20px',  font:"16px/26px Arial, Helvetica, sans-serif"}}><b>Дэлгэрэнгүй</b></h3>
        <hr style={{borderBottom:"2px solid #002d74", margin:'0.6rem 0'}}></hr>


        <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Нэг удаагийн хамгаалах хэрэгсэлийн зардал:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
   
          <small  class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Шатахууны зардал:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
   
          <small  class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Утасны зардал:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
   
          <small  class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Цалин, хөлсний зардал:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
   
          <small  class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Ашиглалтын зардал:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
   
          <small  class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Хөрөнгө бэлтгэсэн зардал:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
   
          <small  class="help-block">/Төгрөгөөр/</small>
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Бусад:</Label>
          <Input type="number" name="SURVEY_ID" id="SURVEY_ID" onChange={this.onChange} value={this.state.SURVEY_ID === null ? '' : this.state.SURVEY_ID}  placeholder="Мөнгөн дүнг төгрөгөөр оруулна уу." required/>
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">ЭМДС-аас авах авлагын дүн:</Label>
          <Input required type="number" name="RENEW_EMP_SALARY" id="RENEW_EMP_SALARY" onChange={this.onChange} value={this.state.RENEW_EMP_SALARY === null ? '' : this.state.RENEW_EMP_SALARY}  placeholder="Мөнгөн дүнг төгрөрөөр оруулна уу." />
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Нэхэмжлэл олгосон санхүүжилтийн зөрүү :</Label>
          <Input required type="number" name="RENEW_EMP_SALARY" id="RENEW_EMP_SALARY" onChange={this.onChange} value={this.state.RENEW_EMP_SALARY === null ? '' : this.state.RENEW_EMP_SALARY}  placeholder="Мөнгөн дүнг төгрөрөөр оруулна уу." />
        ...
        <FormGroup>
          ...
          <Label style={{font:"16px/26px Arial, Helvetica, sans-serif"}} for="RENEW_EMP_SALARY">Тайлбар, тодруулга:</Label><br></br>
          <Input required type="textarea" name="RENEW_EMP_SALARY" id="RENEW_EMP_SALARY" onChange={this.onChange} value={this.state.RENEW_EMP_SALARY === null ? '' : this.state.RENEW_EMP_SALARY}/>
